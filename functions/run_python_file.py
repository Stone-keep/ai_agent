...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Executes a Python file at a specified path with optional arguments.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                description="List of string arguments to pass to the Python file when executing (default is None so it's optional)."
            ),
        },
        required=["file_path"]
    ),
